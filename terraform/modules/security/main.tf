resource "aws_security_group" "qlink_alb_group" {
...
resource "aws_security_group" "qlink_app_group" {
...
resource "aws_vpc_security_group_ingress_rule" "alb_http" {
  security_group_id = aws_security_group.qlink_alb_group.id
  cidr_ipv4         = "0.0.0.0/0"
  from_port         = 80
  to_port           = 80
  ip_protocol       = "tcp"
...
resource "aws_vpc_security_group_ingress_rule" "ecs_from_alb" {
  ...
  referenced_security_group_id = aws_security_group.qlink_alb_group.id
  from_port                    = 0
  to_port                      = 65535
  ip_protocol                  = "tcp"
  description                  = "From ALB to ECS"
