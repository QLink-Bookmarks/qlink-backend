...
class GetFolderMembersService(
    ...
    suspend fun getFolderMembers(
        ...
        tx.readOnly {
            ...
            if (!folderMemberRepository.existsByFolderIdAndUserId(folderId = folderId, userId = loginId)) {
                throw BusinessException(ErrorCode.FOLDER_MEMBER_ACCESS_DENIED)
            }
            ...
            val members =
                folderMemberRepository
                    .findAllByFolderIdOrderByJoinedAtDesc(folderId)
                    .map {
