                ...
                response {
                    ...
                    code(HttpStatusCode.BadRequest) {
                        ...
                        body<ApiResponse<ErrorDetail>> {
                            example(ErrorCode.LINK_URL_BLANK.code) {
                                description = ErrorCode.LINK_URL_BLANK.message
                                value =
                                    ApiResponse(
                                        success = false,
                                        error =
                                            ErrorDetail(
                                                code = ErrorCode.LINK_URL_BLANK.code,
                                                message = ErrorCode.LINK_URL_BLANK.message,
                                            ),
                                    )
                            }
                        }
