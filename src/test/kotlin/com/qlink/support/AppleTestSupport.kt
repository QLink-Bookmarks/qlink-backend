...
/**
 * 애플 id_token 검증 테스트용 키/토큰/JWKS 생성기. 실제 RSA 키쌍으로 토큰을 서명하고,
 * 대응하는 공개키를 JWKS 응답(모킹된 외부 통신)으로 내려준다.
 */
object AppleTestKeys {
    const val KEY_ID = "test-apple-key"
    const val ISSUER = "https://appleid.apple.com"
    const val CLIENT_ID = "com.qlinkapps.qlink"
